...
export function AddImageForm({ onImageAdded }: AddImageFormProps) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const newImage: ImagePlaceholder = { ...values };

    onImageAdded(newImage);

    toast({
      title: "Image ajoutée !",
      description: "La nouvelle image a été créée avec succès.",
    });
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="partner-logo-1" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
