      ...
      <section className="py-20 lg:py-24">
        <div className="container mx-auto px-4">
          <div className="prose dark:prose-invert max-w-4xl mx-auto font-body">
            ...
            <h2>SECTION 1 : RÈGLES APPLICABLES AUX PERSONNES CONCERNÉES PAR LES RENSEIGNEMENTS PERSONNELS RÉGIS PAR LE RGPD</h2>
            ...
            <h2>SECTION 2 : RÈGLES APPLICABLES AUX PERSONNES CONCERNÉES PAR LES RENSEIGNEMENTS PERSONNELS RÉGIS PAR LA LPRPSP (QUÉBEC, CANADA)</h2>
